...
fn make_seed(room_id: u128, location: u128) -> u256 {
    _make_seed(room_id, location, get_block_hash())
}

fn _make_seed(room_id: u128, location: u128, block_hash: u128) -> u256 {
    let h1 = hash_u128(room_id, location);
