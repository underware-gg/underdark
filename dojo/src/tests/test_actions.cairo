...
//         execute_generate_level(world, system, location, dir, 'whateverrrr', 0);
...
//         let chamber1: Chamber = generate_level_get_chamber(world, system, loc1, Dir::Under, 'whateverrrr', 0);
...
//         // first chamber will always use the 'entry' generator
//         let chamber2 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber1.location_id), Dir::West, 'collapse', 55);
...
//         let loc1: Location = Location { game_id:1, over:0, under:0, north:1, east:1, west:0, south:0 };
//         // first chamber will always use the 'entry' generator
//         let chamber1: Chamber = generate_level_get_chamber(world, system, loc1, Dir::Under, 'the_invalid_generator', 0);
//         // now a bad generator to panic...
//         let chamber2 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber1.location_id), Dir::West, 'the_invalid_generator', 0);
//     }
...
//     fn test_yonder() {
//         let (world, system) = setup_world();
//         let loc_y1: Location = Location { game_id:1, over:0, under:0, north:1, east:1, west:0, south:0 };
//         let chamber_y1: Chamber = generate_level_get_chamber(world, system, loc_y1, Dir::Under, 'entry', 0);
//         let chamber_y2_1: Chamber = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber_y1.location_id), Dir::North, 'seed', 0);
//         let chamber_y3_1: Chamber = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber_y2_1.location_id), Dir::West, 'seed', 0);
//         let chamber_y4_1: Chamber = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber_y3_1.location_id), Dir::North, 'seed', 0);
//         let chamber_y4_2: Chamber = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber_y3_1.location_id), Dir::West, 'seed', 0);
//         let chamber_y4_3: Chamber = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber_y3_1.location_id), Dir::South, 'seed', 0);
//         let chamber_y2_2: Chamber = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber_y1.location_id), Dir::South, 'seed', 0);
//         let chamber_y3_2: Chamber = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber_y2_2.location_id), Dir::South, 'seed', 0);
...
//         let (world, system) = setup_world();
//         let (location, dir, to_location_id) = make_from_location();
//         execute_generate_level(world, system, location, dir, 'binary_tree_classic', 0);
//         execute_generate_level(world, system, location, dir, 'binary_tree_classic', 0);
//     }
...
//     #[available_gas(1_000_000_000)]
//     fn test_generate_level_invalid_from_dir() {
//         let (world, system) = setup_world();
//         let (location, dir, to_location_id) = make_from_location();
//         execute_generate_level(world, system, location, Dir::Over, 'binary_tree_classic', 0);
//     }

//     #[test]
//     #[should_panic(expected:('from_door does not exist','ENTRYPOINT_FAILED'))]
//     #[available_gas(1_000_000_000)]
//     fn test_generate_level_entry_has_no_under() {
//         let (world, system) = setup_world();
//         let loc1: Location = Location { game_id:1, over:0, under:0, north:1, east:1, west:0, south:0 };
//         let chamber1: Chamber = generate_level_get_chamber(world, system, loc1, Dir::Under, 'connection', 0);
//         execute_generate_level(world, system, LocationTrait::from_id(chamber1.location_id), Dir::Under, 'connection', 0);
//     }
...
//         let (world, system) = setup_world();
//         let loc1: Location = Location { game_id:1, over:0, under:0, north:1, east:1, west:0, south:0 };
//         let loc2: Location = Location { game_id:1, over:0, under:0, north:2, east:1, west:0, south:0 };
...
//         // panic here...
//         let chamber2: Chamber = generate_level_get_chamber(world, system, loc2, Dir::Under, 'seed', 0);
//     }

//     #[test]
//     #[available_gas(1_000_000_000)]
//     fn test_generate_level_baseline_OK() {
//         let (world, system) = setup_world();
//         let location: Location = Location { game_id:1, over:0, under:0, north:1, east:1, west:0, south:0 };
//         execute_generate_level(world, system, location, Dir::Under, 'binary_tree_classic', 0);
//     }

//     #[test]
//     #[should_panic(expected:('Invalid chamber_location','ENTRYPOINT_FAILED'))]
//     #[available_gas(1_000_000_000)]
//     fn test_generate_level_baseline_NOK() {
//         let (world, system) = setup_world();
//         let location: Location = Location { game_id:1, over:0, under:0, north:1, east:1, west:0, south:0 };
//         execute_generate_level(world, system, location, Dir::West, 'binary_tree_classic', 0);
//     }

//     #[test]
//     #[should_panic(expected:('Invalid Entry from_location','ENTRYPOINT_FAILED'))]
//     #[available_gas(1_000_000_000)]
//     fn test_generate_level_invalid_entry_location() {
//         let (world, system) = setup_world();
//         let location: Location = Location { game_id:1, over:0, under:0, north:1, east:0, west:0, south:1 };
//         execute_generate_level(world, system, location, Dir::Under, 'binary_tree_classic', 0);
//     }
...
//         let (world, system) = setup_world();
//         let location: Location = Location { game_id:1, over:0, under:1, north:11, east:11, west:0, south:0 };
//         execute_generate_level(world, system, location, Dir::Under, 'binary_tree_classic', 0);
//     }
...
//     #[should_panic(expected:('Invalid chamber_location','ENTRYPOINT_FAILED'))]
//     #[available_gas(1_000_000_000)]
//     fn test_generate_level_invalid_entry_direction() {
//         let (world, system) = setup_world();
//         let location: Location = Location { game_id:1, over:0, under:0, north:1, east:1, west:0, south:0 };
//         execute_generate_level(world, system, location, Dir::East, 'binary_tree_classic', 0);
//     }
