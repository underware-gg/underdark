...
mod tests {
    ...
    fn test_mint_realms_invalid_generator() {
        ...
        let chamber1: Chamber = generate_level_get_chamber(world, system, 1, 1, 'the_invalid_generator', 0);
    ...
    fn test_yonder() {
        let (world, system) = setup_world();
        let chamber_y1: Chamber = generate_level_get_chamber(world, system, 1, 1, 'entry', 0);
        let chamber_y2: Chamber = generate_level_get_chamber(world, system, 1, 2, 'seed', 0);
        let chamber_y3: Chamber = generate_level_get_chamber(world, system, 1, 3, 'seed', 0);
