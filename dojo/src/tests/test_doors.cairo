...
//         // move WEST
//         let chamber2 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber1.location_id), Dir::West, 'seed', 0);
...
//         // move NORTH
//         let chamber3 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber2.location_id), Dir::North, 'seed', 0);
...
//         // move EAST
//         let chamber4 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber3.location_id), Dir::East, 'seed', 0);
...
//         // move EAST+SOUTH
//         let chamber5 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber4.location_id), Dir::East, 'seed', 0);
...
//         let chamber6 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber5.location_id), Dir::South, 'seed', 0);
...
//         // move SOUTH+WEST
//         let chamber7 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber6.location_id), Dir::South, 'seed', 0);
...
//         let chamber8 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber7.location_id), Dir::West, 'seed', 0);
...
//         // move UNDER
//         let chamber9 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber8.location_id), Dir::Under, 'seed', 0);
...
//         // move NORTH
//         let chamber10 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber9.location_id), Dir::North, 'seed', 0);
...
//         // move WEST
//         let chamber11 = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber10.location_id), Dir::West, 'seed', 0);
...
//         // now, please panic...
//         let chamber3: Chamber = generate_level_get_chamber(world, system, LocationTrait::from_id(chamber2.location_id), Dir::West, 'connection', 0);
//     }
